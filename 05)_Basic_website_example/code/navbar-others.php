                        	...
                        	<div class="panel-body">
                            	...
                            	<form>
                                  ...
                                  <div class="checkbox">
                                     ...
                                     <a aria-label="Close" data-dismiss="modal" data-target="#exampleModal2" data-toggle="modal" href="#exampleModal2" class="pull-right">Forgot Password?</a>
                                     <div aria-labelledby="exampleModalLabel" role="dialog" tabindex="-1" id="exampleModal2" class="modal fade">
                                      <div role="document" class="modal-dialog">
                                        <div class="modal-content">
                                         <form method="post">
                                          <div class="modal-header">
                                            <button aria-label="Close" data-dismiss="modal" class="close" type="button"><span aria-hidden="true">×</span></button>
                                            <h4 id="exampleModalLabel" class="modal-title">Forgot Password</h4>
                                          </div>
                                          ...
                                          <div class="modal-footer">
                                            <input type="submit" value="Submit" name="forgetnow" class="btn btn-primary">
                                          </div>
                                          </form>
                                        </div>
                                      </div>
